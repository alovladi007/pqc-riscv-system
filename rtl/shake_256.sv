...
// shake_256.sv
//
// SHAKE-256 sponge wrapped around keccak_f1600. Produces an arbitrary
...
//
// FIPS 202 §B.1 lane traversal extended to 21 lanes for the SHAKE-256 rate.
...
module shake_256 (
    ...
    // ---------------------------------------------------------------------
    // FIPS 202 §B.1 lane traversal (extended to 21 lanes for SHAKE-256's rate)
    // ---------------------------------------------------------------------
